...
## 📂 Project Structure
* `data/raw/`: Original Olist e-commerce datasets used for ingestion.
* `notebooks/`: PySpark notebooks for Bronze, Silver, and Gold layers.
* `images/`: Architecture diagrams, pipeline screenshots, and Power BI reports.

## ⚙️ Data Pipeline Execution (The Medallion Architecture)

### 🥉 Bronze Layer: Raw Data Ingestion
* **File:** `notebooks/01_Ingest_Raw_to_Bronze.ipynb`
...
| End-to-End Process Flow | Final Data Pipeline |
| :--- | :--- |
| ![Process Flow](images/end-to-end_process_lh_olist.png) | ![Pipeline](images/final_pipleine_olist.png) |
...
### 📈 Final Dashboard
![Power BI Dashboard](images/power%20BI%20report%20olist.png)
